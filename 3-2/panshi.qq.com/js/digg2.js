...
if (typeof AppPlatform.Survey.Digg == "undefined") {
    AppPlatform.Survey.Digg = {
        ...
        loadDiggResult: function(projId) {
            ...
            var LoadUrl = "http://panshi.qq.com/vote/" + AppPlatform.Survey.Digg.ProjectList[projId].ProjectId + "/result?source=1&callback=AppPlatform.Survey.Digg.showDiggResult&_=" + Math.random();
        ...
        digg: function(obj, projId, subjId, optId) {
            ...
            */
            ...
            AppPlatform.Survey.Digg.submit("http://panshi.qq.com/v2/vote/" + projId + "/submit", data);
        },
        ...
        submit: function(url, data) {
            ...
            _$form.submit();
            /*
            if (document.getElementsByName("Ansy_Post").length == 0) {
                ansypost = document.createElement("iframe");
                ansypost.name = 'Ansy_Post';
                ansypost.id = 'Ansy_Post';
                ansypost.style.cssText = "display:none;"
                ansypost.innerHtml = '<script type="text/javascript">document.domain = "qq.com";</script>';
                document.body.appendChild(ansypost);
            }

            var syncform = document.forms['sync_form'];
            if (typeof syncform == "undefined") {
                syncform = document.createElement("form");
                syncform.name = 'sync_form';
                document.body.appendChild(syncform);
            }
            syncform.action = url;
            syncform.target = "Ansy_Post";
