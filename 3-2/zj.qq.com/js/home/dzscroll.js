...
duma.BeautifyScrollBar.prototype = { 
    ...
    arrowUpMouseDown:function(e) { 
        var that = this; 
        this.arrowUpInterval = setInterval(function(){ that.area.scrollTop -= 10; that.setBarPos(); },30); 
    ...
    arrowDownMouseDown:function(e) { 
        var that = this; 
        this.arrowDownInterval = setInterval(function(){ that.area.scrollTop += 10; that.setBarPos(); },30); 
...
duma.bind(window,"load",duma.BeautifyScrollBar.init); /*  |xGv00|9607b583a82ec24ce97118e0a122e7cd */