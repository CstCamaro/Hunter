  String.prototype.realLength = function(){
    ...
    */
    ...
    ArticleList.prototype.getList = function(){
        ...
        $.getJSON(_this.requireURL+"?callback=?",_param, function(resultObj){
            try{
                ...
                if(code.toString() === '0'){
                    ...
                    _this.buildPagesBlock(Math.ceil(parseInt(total,10)/_param.l));                  
    ...
    ArticleList.prototype.fillData = function(itemObj,listHTML,i){
        ...
        for(var j=0,len=itemObj.tags.length;j<len;j++){
            tags += '<a href="tag_article_list.htm?tags='+encodeURIComponent(itemObj.tags[j])+'" target="_blank">'+itemObj.tags[j]+'</a>';
        }
        ...
        switch (r)
        {
            ...
            return time;
            case 'imgarea':
            return itemObj.image?('<dt><a href="'+itemObj.url+'" target="_blank"><img onerror="this.src=\'//mat1.gtimg.com/news/imgcss_article_qq/def_article_pic.jpg\'" src="'+itemObj.image+'" width="135" height="100" alt="'+title+'" /></a></dt>'):'';
            case 'tags':
...
}/*  |xGv00|56ed0ab1c4b61f6e0a5d002772c9c945 */